...
void Monitor_remove(Monitor *mb, Pessoa *pessoas, int item) {
    ...
    pessoas[item].Prioridade = pessoas[item].PrioridadeOriginal;
    mb->count--;
...
void Pessoa_init(Pessoa pessoas[]){
    ...
    for (int i = 0; i < PESSOAS; i++)
    {
        pessoas[i].PrioridadeOriginal = pessoas[i].Prioridade;
    }
...
int Passar_vez(Monitor *mb, Pessoa *pessoas, int escolhido, int candidato){
    switch (pessoas[escolhido].Prioridade)
    {
        case 3:
        {
            if (pessoas[candidato].Prioridade == 1)
            {
                return 1;
            }
            return 0;
        ...
        case 1:
        {
            if (pessoas[candidato].Prioridade == 2)
            {
                return 1;
            }
            return 0;
        ...
        case 2:
        {
            if (pessoas[candidato].Prioridade == 3)
            {
                return 1;
            }
        ...
        case 0:
        {
            if (pessoas[candidato].Prioridade > pessoas[escolhido].Prioridade)
            {
                return 1;
            }
...
void Proximo_na_fila(Monitor *mb, Pessoa pessoas[])
{
    ...
    for (int i = 0; i < PESSOAS; i++) {
        ...
        if (escolhido == -1 || Passar_vez(mb,pessoas,escolhido,id)) {
            escolhido = id;
        }
    }

    if (gravida && deficiente && idoso)
    {
